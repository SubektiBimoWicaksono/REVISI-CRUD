...
$hasil = mysqli_query($koneksi, "UPDATE pegawai SET nama='$nama', tgl_lahir = '$tgl_lahir', jk = '$jk', agama = '$agama', posisi='$posisi', perusahaan='$perusahaan', foto='$foto' WHERE id_pegawai='$id_pegawai'");
